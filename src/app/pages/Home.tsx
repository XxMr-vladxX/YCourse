      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500">
        ...
        <div className="container relative mx-auto px-4 py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-9 text-xl text-white/90">
              Descubre cursos de programación, diseño, modelado 3D y desarrollo de videojuegos para mejorar tu conocimiento!
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <div className="flex items-center gap-2 text-white">
                <span className="font-semibold">Instrucciones claras</span>
              </div>
              <div className="h-1 w-1 rounded-full bg-white/50"></div>
              <div className="flex items-center gap-2 text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {filteredCourses.length === 0 && (
          <div className="py-20 text-center">
            <p className="text-gray-500">No se encontraron cursos en esta categoría</p>
          </div>
        )}
      </div>
